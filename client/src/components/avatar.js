    ...
    const spellingLoop = (timestamp) => {
      ...
      if (this.elements.rightHandSpelling && activeChar && activeChar !== lastRenderedChar) {
        ...
        if (handPaths) {
          ...
          // Scale and translate the fingerspelling paths to center at (0,0) and make it proportional
          this.elements.rightHandSpelling.innerHTML = `<g transform="scale(0.75) translate(-50, -70)">${handPaths}</g>`;
        }
      }
