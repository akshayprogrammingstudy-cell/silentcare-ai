...
const TRANSLATIONS = {
  en: {
    ...
    accuracy: "Accuracy",
    status: "Status",
    save_to_browser: "Save Model to Browser",
    model_saved: "Model saved successfully to IndexedDB!",
    model_loaded: "Trained ASL model loaded successfully!",
    load_failed: "No pre-trained model found in browser storage.",
    clear_saved_model: "Delete Saved Model",
    nn_mode_active: "Neural Network Mode Active",
    heuristic_mode_active: "Heuristic Mode Active",
    toggle_ai_mode: "Toggle Recognition Mode",
  ...
  ta: {
    ...
    model_trainer: "மாதிரிப் பயிற்சியாளர்",
    train_model: "ASL மாதிரியைப் பயிற்றுவிக்கவும்",
    learning_parameters: "கற்றல் அளவுருக்கள்",
    epochs: "சுற்றுகள் (Epochs)",
    learning_rate: "கற்றல் விகிதம்",
    batch_size: "தொகுதி அளவு",
    loss: "இழப்பு (Loss)",
    accuracy: "துல்லியம்",
    status: "நிலை",
    save_to_browser: "மாதிரியை உலாவியில் சேமி",
    model_saved: "மாதிரி IndexedDB இல் வெற்றிகரமாக சேமிக்கப்பட்டது!",
    model_loaded: "பயிற்சி பெற்ற ASL மாதிரி வெற்றிகரமாக ஏற்றப்பட்டது!",
    load_failed: "உலாவி சேமிப்பகத்தில் மாதிரி எதுவும் இல்லை.",
    clear_saved_model: "சேமித்த மாதிரியை நீக்கு",
    nn_mode_active: "நரம்பியல் நெட்வொர்க் பயன்முறை செயலில் உள்ளது",
    heuristic_mode_active: "நெறிமுறை பயன்முறை செயலில் உள்ளது",
    toggle_ai_mode: "அங்கீகார பயன்முறையை மாற்று",
